...
import { actorSchema, ActorFormValues } from '../validation/actorSchema'

interface ActorFormProps {
  onSubmit: (data: ActorFormValues) => void
  defaultValues?: ActorFormValues
  isSubmitting: boolean
}

export default function ActorForm({ onSubmit, defaultValues, isSubmitting }: ActorFormProps) {
  const { register, handleSubmit, formState: { errors } } = useForm<ActorFormValues>({
